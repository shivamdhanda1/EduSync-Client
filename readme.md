...
- Change the current working directory to where you want to store the EduSync project.
- Run the following command to clone the frontend repository:
```bash
git clone https://github.com/shivamdhanda1/EduSync-Client.git
```
#### 3 Install Frontend Dependencies:
- Change the current working directory to the project's frontend folder (e.g., EduSync-Client).
...
- Refer [environment variables](https://github.com/shivamdhanda1/EduSync-Client#environment-variables) for setting up the required environment variables for the LearnEase frontend.
...
[LearnEase Backend Repository](https://github.com/shivamdhanda1/EduSync-Server)
...
If you have any feedback, please reach me at shahsadkpklr@gmail.com or connect me at [LinkedIn](https://www.linkedin.com/in/shivam-dhanda/)
